...
\renewcommand{\maketitle}{
  \begin{center}
    ...
    {\href{mailto:dannylongeuay@gmail.com}{dannylongeuay@gmail.com} -- \href{https://www.linkedin.com/in/dannylongeuay/}{linkedin.com/in/dannylongeuay/} -- \href{https://github.com/dannylongeuay}{github.com/dannylongeuay}}
  \end{center}
}
...
development, cloud infrastructure, automation, container orchestration and AI. Leverages agentic tooling as
a force multiplier to increase deliverables and focus on higher-level abstractions. Utilizes programming, CI/CD,
...
\section{Technical Skills}
  ...
  \skill{AI}{Context Engineering, Claude, Cursor, ChatGPT, Agentic SDLC, Agent Orchestration}

  \skill{CI/CD}{Github Actions, Gitlab, Argo, Flux}
  ...
  \skill{Monitoring}{Grafana, Elasticsearch, DataDog, InfluxDB, Prometheus, SNMP, Splunk, Syslog}

  \skill{Programming Languages}{Bash, Golang, Java, Javascript/Typescript, Python, Zig}
...
\section{\vspace{.5em}Professional Experience}
  ...
  \experienceHeading{Angi | Engineering Manager}{Feb 2025 - Present}

    \experienceItemListStart

        \experienceItem{AI}{Orchestrate agents to boost productivity and multiply impact across platform and product domains}
        \experienceItem{Technical Leadership}{Lead and mentor the Observability platform team}
        \experienceItem{Coaching}{Foster a positive work environment where team members can grow and tackle new challenges}
        \experienceItem{Ownership}{Take ownership of the entire Observability stack that is growing and evolving to ensure quality}
        \experienceItem{Data-driven}{Deliver a product that provides users with critical service visibility}

    \experienceItemListEnd

  \experienceHeading{Angi | Senior Infrastructure Engineer}{Jul 2022 - Feb 2025}

    \experienceItemListStart

        \experienceItem{Automate}{Design, develop, test, and deploy automation to reduce human labor}
        \experienceItem{Mentoring}{Mentor junior team members on technology, development workflows, and mindset}
        \experienceItem{DevOps}{Develop and manage systems frameworks to deliver highly-available services}
        \experienceItem{Observability}{Design, implement, and improve telemetry/analysis services}

    \experienceItemListEnd

  \experienceHeading{Warner Bros. Discovery | Staff Site Reliability Engineer}{Apr 2022 - Jul 2022}
